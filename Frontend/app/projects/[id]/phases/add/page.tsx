...
import { createDeliverablePhase } from "@/services/deliverablePhase-api";
...
const AddPhasePage = () => {
  ...
  const [project, setProject] = useState<Project | null>(null); // Adjust the type as needed
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Create phase object with projectId
    const newPhase: Omit<DeliverablePhase, "id"> = {
      title,
    ...
    const response = await createDeliverablePhase(newPhase);
...
export default withAuthAdminPM(AddPhasePage); // Protect the page with the HOC
