...
namespace ProjectmanagementService.Migrations
{
    ...
    [Migration("20250523113512_ConfigurePermissionRelationshipsUpppp")]
    partial class ConfigurePermissionRelationshipsUpppp
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjectmanagementService.Models.ProjectPermission", b =>
                {
                    ...
                    b.Property<string>("ProjectMemberPermissionId1")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.HasIndex("ProjectMemberPermissionId1");
            ...
            modelBuilder.Entity("ProjectmanagementService.Models.ProjectPermission", b =>
                {
                    b.HasOne("ProjectmanagementService.Models.ProjectMemberPermission", null)
                    ...
                    b.HasOne("ProjectmanagementService.Models.ProjectMemberPermission", "ProjectMemberPermission")
                        .WithMany()
                        .HasForeignKey("ProjectMemberPermissionId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_ProjectPermissions_ProjectMemberPermissions_ProjectMemberP~1");
